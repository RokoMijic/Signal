...
sum(df_textpr[ , ] == "Yes, I was formally diagnosed by a doctor or other mental health professional" & !is.na(df_textpr[ , ])  )
...
sapply( dplyr::select(  df_textpr , contains("SQ001") ) , unique)[,9]
